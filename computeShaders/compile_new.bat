...
C:/VulkanSDK/1.4.328.1/Bin/glslc.exe OSToTSConverter.vert -o OSToTSConverterVert.spv
C:/VulkanSDK/1.4.328.1/Bin/glslc.exe OSToTSConverter.frag -o OSToTSConverterFrag.spv
